// filepath: /Users/paul.visciano/repos/core/test/wdio/method/matrix/value/method-value-async-none.tsx
import { Component, h, Method, State } from '@stencil/core';

@Component({ tag: 'method-value-async-none', shadow: true })
export class MethodValueAsyncNone {
  @State() value = 0;
