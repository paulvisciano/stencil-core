...
const promiseComponents: Array<{ tag: string; callArgs: unknown[] }> = [
  { tag: 'method-promise-async-none', callArgs: [] },
  { tag: 'method-promise-async-one', callArgs: [2] },
  { tag: 'method-promise-async-false-none', callArgs: [] },
  { tag: 'method-promise-async-false-one', callArgs: [2] }
];
