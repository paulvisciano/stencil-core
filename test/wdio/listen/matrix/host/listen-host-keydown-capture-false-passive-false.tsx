// filepath: /Users/paul.visciano/repos/core/test/wdio/listen/matrix/host/listen-host-keydown-capture-false-passive-false.tsx
...
export class ListenHostKeydownCaptureFalsePassiveFalse {
  ...
  @Listen('keydown', { capture: false, passive: false })
  onEv() {
    this.counter++;
  }
