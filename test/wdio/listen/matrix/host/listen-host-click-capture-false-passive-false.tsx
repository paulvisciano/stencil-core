// filepath: /Users/paul.visciano/repos/core/test/wdio/listen/matrix/host/listen-host-click-capture-false-passive-false.tsx
...
export class ListenHostClickCaptureFalsePassiveFalse {
  ...
  @Listen('click', { capture: false, passive: false })
  onEv() {
    this.counter++;
  }
