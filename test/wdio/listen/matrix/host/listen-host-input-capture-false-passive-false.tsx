// filepath: /Users/paul.visciano/repos/core/test/wdio/listen/matrix/host/listen-host-input-capture-false-passive-false.tsx
...
export class ListenHostInputCaptureFalsePassiveFalse {
  ...
  @Listen('input', { capture: false, passive: false })
  onEv() {
    this.counter++;
  }
