...
export class ListenBodyKeydownCapturePassiveFalse {
  ...
  @Listen('keydown-listen-body-keydown-capture-passive-false', { target: 'body', capture: true, passive: false })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('keydown-listen-body-keydown-capture-passive-false', { bubbles: true, cancelable: true, composed: true });
