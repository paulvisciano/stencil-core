...
export class ListenBodyKeydownCaptureFalsePassive {
  ...
  @Listen('keydown-listen-body-keydown-capture-false-passive', { target: 'body', capture: false, passive: true })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('keydown-listen-body-keydown-capture-false-passive', { bubbles: true, cancelable: true, composed: true });
