...
export class ListenBodyClickCapturePassive {
  ...
  @Listen('click-listen-body-click-capture-passive', { target: 'body', capture: true, passive: true })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('click-listen-body-click-capture-passive', { bubbles: true, cancelable: true, composed: true });
