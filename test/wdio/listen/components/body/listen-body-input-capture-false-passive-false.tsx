...
export class ListenBodyInputCaptureFalsePassiveFalse {
  ...
  @Listen('input-listen-body-input-capture-false-passive-false', { target: 'body', capture: false, passive: false })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('input-listen-body-input-capture-false-passive-false', { bubbles: true, cancelable: true, composed: true });
