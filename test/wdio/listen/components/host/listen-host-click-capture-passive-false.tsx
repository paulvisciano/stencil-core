...
export class ListenHostClickCapturePassiveFalse {
  ...
  @Listen('click-listen-host-click-capture-passive-false', { capture: true, passive: false })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('click-listen-host-click-capture-passive-false', { bubbles: true, cancelable: true, composed: true });
