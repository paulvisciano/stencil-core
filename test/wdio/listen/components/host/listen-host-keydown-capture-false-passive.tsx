...
export class ListenHostKeydownCaptureFalsePassive {
  ...
  @Listen('keydown-listen-host-keydown-capture-false-passive', { capture: false, passive: true })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('keydown-listen-host-keydown-capture-false-passive', { bubbles: true, cancelable: true, composed: true });
