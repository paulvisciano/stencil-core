...
export class ListenHostKeydownCapturePassiveFalse {
  ...
  @Listen('keydown-listen-host-keydown-capture-passive-false', { capture: true, passive: false })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('keydown-listen-host-keydown-capture-passive-false', { bubbles: true, cancelable: true, composed: true });
