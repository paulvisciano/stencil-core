...
export class ListenDocumentInputCaptureFalsePassiveFalse {
  ...
  @Listen('input-listen-document-input-capture-false-passive-false', { target: 'document', capture: false, passive: false })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('input-listen-document-input-capture-false-passive-false', { bubbles: true, cancelable: true, composed: true });
