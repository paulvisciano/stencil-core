...
export class ListenWindowClickCapturePassive {
  ...
  @Listen('click-listen-window-click-capture-passive', { target: 'window', capture: true, passive: true })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('click-listen-window-click-capture-passive', { bubbles: true, cancelable: true, composed: true });
