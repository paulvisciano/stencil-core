...
export class ListenWindowClickCapturePassiveFalse {
  ...
  @Listen('click-listen-window-click-capture-passive-false', { target: 'window', capture: true, passive: false })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('click-listen-window-click-capture-passive-false', { bubbles: true, cancelable: true, composed: true });
