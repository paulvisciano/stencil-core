...
export class ListenWindowClickCaptureFalsePassiveFalse {
  ...
  @Listen('click-listen-window-click-capture-false-passive-false', { target: 'window', capture: false, passive: false })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('click-listen-window-click-capture-false-passive-false', { bubbles: true, cancelable: true, composed: true });
