...
export class ListenWindowKeydownCapturePassiveFalse {
  ...
  @Listen('keydown-listen-window-keydown-capture-passive-false', { target: 'window', capture: true, passive: false })
  onEv() {
    this.counter++;
  }
  ...
  async componentDidLoad() {
    ...
    const ev = new Event('keydown-listen-window-keydown-capture-passive-false', { bubbles: true, cancelable: true, composed: true });
