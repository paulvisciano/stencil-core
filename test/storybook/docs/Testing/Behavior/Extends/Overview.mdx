...
export const ExtendsTestCasesTable = () => {
  ...
  return <TestCasesTable rows={allRows} previewCount={13} />;
};
...
**🟡 Standard Patterns (Complete + New TODOs):**
...
7. **📋 Test Case #7 TODO**: Event Handling Inheritance - @Listen decorators and event propagation
8. **📋 Test Case #8 TODO**: Watch Decorator Inheritance - @Watch behavior through inheritance chains

**🔴 Advanced Real-World Controllers:**
9. ✅ **Test Case #9**: Controller-initiated updates (requestUpdate pattern) - **5 passing tests**
10. **📋 Test Case #10 TODO**: FloatingUI Controller - Real-world Popper.js integration for Bricks components
11. **📋 Test Case #11 TODO**: ValidationController - Real-world form validation for Bricks components

**🟠 Robustness & Production:**
12. **📋 Test Case #12 TODO**: Decorator Conflicts & Edge Cases - Duplicate decorators, compiler behavior, inheritance conflicts
13. **📋 Test Case #13 TODO**: SSR & Hydration - Server-side rendering and hydration behavior with inheritance chains

**Next Steps:**
   - **Test Cases #7-8**: Core decorator inheritance (Event handling, Watch decorators) 
   - **Test Case #12**: Critical robustness testing for decorator conflicts and edge cases
   - **Test Case #13**: Production-critical SSR & hydration testing
   - Add property and state mutation tests for existing scenarios
