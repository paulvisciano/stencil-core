...
export const ExtendsTestCasesTable = () => {
  ...
  const allRows = [
    ...
    // 🔵 Advanced Composition Pattern (14)
    {
      id: 14,
    ...
    // 🔵 Advanced Scaling Demonstrations (15-16)
    {
      id: 15,
...
### **🔵 Advanced Real-World (12, 12a, 14-16)** — 5 test cases
...
### **🔴 Robustness & Production (13, 18)** — 2 test cases
...
export const ExtendsTODOSection = () => {
  ...
  const categories = {
    ...
    '🔵 Advanced Real-World': [12, '12a', 14, 15, 16],
    '🔴 Robustness & Production': [13, 18],
  };
