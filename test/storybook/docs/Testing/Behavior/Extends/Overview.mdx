    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px', marginBottom: '32px' }}>
      ...
      <div style={{ 
        ...
        <div style={{ fontSize: '11px', color: '#15803d', opacity: 0.8, borderTop: '1px solid #86efac', paddingTop: '8px', marginTop: '8px' }}>
          📅 Last run: Nov 17, 2025, 6:18 PM PST</div>
      </div>
    </div>
  );
};
...
export const ExtendsTestCasesTable = () => {
  ...
  const allRows = [
    ...
    // 🔵 Advanced Reactive Controllers (12-12b)
    {
      id: 12,
    ...
    {
      id: '12b',
      implemented: testCaseStatus['12b']?.implemented || false,
      desc: testCaseStatus['12b']?.description || '',
      types: (
        <>
          ...
          <small>Automatic lifecycle hooking with composition over inheritance | {formatTestCount(testCaseStatus['12b'])}</small>
        </>
      ),
      tested: getGroupStats('via-host').tested,
      total: getGroupStats('via-host').total,
      testCount: testCaseStatus['12b']?.testCount || 0,
      section: testCaseStatus['12b']?.implemented ? 'implemented' : 'missing',
    },
...
### **🔵 Advanced Real-World (12, 12a, 12b, 13-14)** — 5 test cases
