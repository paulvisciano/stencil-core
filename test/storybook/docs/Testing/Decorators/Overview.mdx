import componentData from './Component/data/components.json';
import propData from './Prop/data/test-coverage.json';
import stateData from './State/data/test-coverage.json';
import eventData from './Event/data/test-coverage.json';
import listenData from './Listen/data/test-coverage.json';
import methodData from './Method/data/test-coverage.json';
...
- Record results in each decorator's `data/test-coverage.json` (`tested`, `testedBy`) so the "Tested / Test Cases" column reflects reality.
...
<div style={{ maxWidth: '100%', width: '100%', background: '#fff' }}>
  <table style={{ width: '100%', borderCollapse: 'collapse', tableLayout: 'fixed' }}>
    ...
    <thead>
      <tr>
        <th>Decorator</th>
        <th style={{ textAlign: 'center' }}>Components Generated %</th>
      </tr>
    </thead>
    <tbody>
      <tr>
