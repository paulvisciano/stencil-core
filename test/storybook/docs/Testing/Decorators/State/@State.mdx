...
- Matrix conventions: generated examples are grouped by state type under `test/wdio/state-new/matrix/<type>`; files live directly in the type subfolder (e.g., `string/`, `number/`).
...
To simplify navigation of the generated matrix, components are organized by state type under `test/wdio/state-new/matrix/`:
  ...
  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
    ...
    <tbody>
      <tr>
        ...
        <td style={{ padding: '8px', border: '1px solid #ddd' }}>
          <code>test/wdio/state-new/tests</code>
        </td>
      </tr>
