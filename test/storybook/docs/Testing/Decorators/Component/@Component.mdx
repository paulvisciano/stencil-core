...
<p style={{ marginTop: 8 }}>
  ...
  <code>rules.json</code>, update the list, and regenerate. Use the toggle to expand or collapse the full list.
  <br/>
...
Components are grouped one level deep by render mode under `test/wdio/component-decorator/matrix/`:
...
- Planned tests land in Phase 2. Phase 1 is compile-only: generate components (unique option combos) and use the compiler to discover rules/errors. This section is a placeholder for the shared test summary to be added in Phase 2.
