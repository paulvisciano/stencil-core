...
- `npm run coverage-component-tests` → updates `Testing/Decorators/*-coverage-data.json` including `component-coverage-data.json`.
...
- `npm run coverage-component-tests` → expect `covered === total` for `component-coverage-data.json`.
