...
<Meta title="Testing/Framework/Overview" />
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>[Core Testing Docs](?path=/docs/testing-tests-core--docs)</td>
    </tr>
    <tr>
      ...
      <td>[Component Testing Docs](?path=/docs/testing-tests-component--docs)</td>
    </tr>
    <tr>
      ...
      <td>[E2E Testing Docs](?path=/docs/testing-tests-e2e--docs)</td>
    </tr>
  </tbody>
</table>
...
<div style={{ marginTop: '3rem', textAlign: 'center' }}>
  <span style={{
    ...
    <span style={{ display: 'block', fontSize: 28, color: '#0ea5e9', fontWeight: 900, marginBottom: 18, zIndex: 1, position: 'relative', letterSpacing: '0.04em' }}>
      🚀 [2025 Testing Roadmap: Dive into the future of Stencil.js testing!](?path=/docs/testing-roadmap-2025--docs) 🚀
    </span>
