...
**How to use:**
- Build WDIO components: `npm run build-component-tests`
- Run WDIO component tests: `npm run run-component-tests`
- Run the component coverage script (all decorators): `npm run coverage-component-tests`
...
- Run a specific coverage script (e.g., state): `npm run coverage-state`
