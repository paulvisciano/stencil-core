import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as s}from"./index-D-iNwUTw.js";import{M as o}from"./blocks-cDThjR1y.js";import"./iframe-BQbRq0hK.js";import"./preload-helper-D9Z9MdNV.js";import"./index-cEMhdOia.js";function r(i){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",li:"li",ol:"ol",p:"p",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Testing/Framework/Context Pack",tags:["pending-review"]}),`
...
`]}),`
`]}),`
`,e.jsxs(n.li,{children:["Generation loop (preferred models):",`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Use GPT-5 (Preview) for component/test generation"}),`
`,e.jsx(n.li,{children:"Use GPT-4.1 for documentation"}),`
`,e.jsxs(n.li,{children:["Always reference ",e.jsx(n.code,{children:"AGENT_KEYWORDS.md"})," for standardized prompts"]}),`
`]}),`
`]}),`
...
`]}),`
`]}),`
`,e.jsx(n.li,{children:"Manual verification: tweak a few options in generated files and confirm the coverage report updates"}),`
`]}),`
...
`]})]})}function x(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{x as default};
