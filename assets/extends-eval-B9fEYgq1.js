import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as t}from"./index-LEn82Xdr.js";import{M as o}from"./blocks-Be46xOuq.js";import"./iframe-CUSS-ND5.js";import"./preload-helper-D9Z9MdNV.js";import"./index-CqKsMeIy.js";const r=""+new URL("extends-compiler-error-BAwOuV-h.png",import.meta.url).href;function s(i){const n={a:"a",blockquote:"blockquote",br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Testing/Behavior/Composition/Extends Evaluation",tags:["pending-review"]}),`
`,e.jsx(n.h1,{id:"extends-only-phase-1-evaluation",children:"Extends-Only Phase 1 Evaluation"}),`
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["Historical background: see ",e.jsx(n.a,{href:"?path=/docs/testing-behavior-composition-historical-controller-context--docs",children:"Historical @Controller Context"}),"."]}),`
`]}),`
...
`,e.jsx("img",{src:r,alt:"Compiler error when extending from a base class on older Stencil",style:{maxWidth:"780px",border:"1px solid #eee",borderRadius:"4px"}}),`
...
L6:   @State() value: string = '';
`})}),`
`,e.jsxs(n.p,{children:["Action: pull latest ",e.jsx(n.code,{children:"stenciljs/core"})," that includes PR #6362 to enable ",e.jsx(n.code,{children:"extends"})," and mixins support before running these WDIO tests."]})]})}function x(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(s,{...i})}):s(i)}export{x as default};
