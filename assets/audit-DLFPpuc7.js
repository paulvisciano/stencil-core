...
`,e.jsxs(n.p,{children:["For every completed GenAI-powered testing loop, ensure that all learnings, mistakes, and improvements are documented in the relevant ",e.jsx(n.code,{children:".ai"})," folder file and summarized here in the audit log. This practice helps maintain a robust knowledge base and supports continuous improvement for future contributors."]})]})}function x(t={}){const{wrapper:n}={...i(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{x as default};
