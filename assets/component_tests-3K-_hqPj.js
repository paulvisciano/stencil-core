import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{useMDXComponents as i}from"./index-Cz8RAiW5.js";import{M as o}from"./blocks-CteF97tp.js";import"./iframe-C9EEsFzF.js";import"./preload-helper-D9Z9MdNV.js";import"./index-CzFh4XEe.js";function s(t){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Testing/Tests/Component"}),`
...
`,e.jsx(n.p,{children:"To run the coverage script, use the following command:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`cd test/storybook && npm run coverage
`})}),`
`,e.jsx(n.p,{children:"This command will analyze the existing test suite and generate a report, giving you a clear picture of where new test components are needed for full permutation coverage."}),`
...
`,e.jsxs(n.p,{children:["After creating or modifying your test components, you need to build them. Navigate to the ",e.jsx(n.code,{children:"wdio"})," test directory and run the build command:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`cd test/wdio
npm run build
`})}),`
...
`]}),`
`,e.jsxs(n.li,{children:[`
`,e.jsxs(n.p,{children:[e.jsxs(n.strong,{children:["Run the tests from the ",e.jsx(n.code,{children:"test/wdio"})," directory"]}),":"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`npm run wdio
`})}),`
`]}),`
`]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Build/Test Workflow:"})," Always follow the documented build and test workflow (",e.jsx(n.code,{children:"cd test/wdio && npm run build"}),", then ",e.jsx(n.code,{children:"npm run wdio"}),"). Update documentation if the process changes."]}),`
