...
`,e.jsxs(n.li,{children:["Record results in each decorator's ",e.jsx(n.code,{children:"data/test-coverage.json"})," (",e.jsx(n.code,{children:"tested"}),", ",e.jsx(n.code,{children:"testedBy"}),') so the "Tested / Test Cases" column reflects reality.']}),`
...
`,e.jsxs(n.p,{children:["For a high-level overview of test coverage across all decorators and behavior testing, see the ",e.jsx(n.a,{href:"?path=/docs/testing-coverage-report--docs",children:"Coverage Report"}),"."]})]})}function l(t={}){const{wrapper:n}={...r(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}export{l as default};
