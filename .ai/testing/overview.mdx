...
> **Note:** For a deeper dive into how the permutation matrix is generated and used for coverage, see [Matrix Generation](?path=/docs/testing-decorators-matrix-generation--docs).
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>[Core Testing Docs](?path=/docs/testing-core-tests--docs)</td>
    </tr>
    <tr>
      ...
      <td>[Component Testing Docs](?path=/docs/testing-component-tests--docs)</td>
    </tr>
    <tr>
      ...
      <td>[E2E Testing Docs](?path=/docs/testing-e2e-tests--docs)</td>
    </tr>
  </tbody>
</table>
...
## Matrix-Driven Static Analysis Coverage
...
To address this, we use a matrix-driven static analysis approach:

- **Permutation Matrix:** For each decorator, all possible permutations (based on its properties/options) are enumerated in a machine-readable matrix (typically an `.mdx` file). For more on how this matrix is created and maintained, see [Matrix Generation](?path=/docs/testing-decorators-matrix-generation--docs).
...
A core tenet of this continuous improvement is the practice of documenting our learnings. After each major testing iteration, we will update the relevant documentation—including this strategy, the component-level and end-to-end testing guides, and the [audit log](?path=/docs/testing-audit--docs)—with any new insights, patterns, or challenges we encountered. This ensures that our institutional knowledge grows with our test suite.
